  ...
  {isOpen ? (
    ...
    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
      ...
      >
        ...
        <button type="button" className="relative mt-3 w-32 h-12 inline-flex justify-center items-center px-3.5 py-2 border-2 border-secondary-100 bg-transparent text-sm text-secondary-100 font-medium">
        Resume
      </button>
      </div>
